...
const About = () => {
  return (
    <div className='lg:px-40 px-6 my-20'>
        <div className='w-full text-center'>
        <h1 className="px-2 mb-2 mt-0 text-6xl font-extrabold leading-tight">About Us</h1>
        <p className='lg:text-2xl text-xl text-left'>
