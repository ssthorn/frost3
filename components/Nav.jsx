...
const Nav = () => {
  return (
    ...
    <div className='drawer-content flex flex-col'>
      {/* Navbar */}
      <div className='w-full navbar md:p-0 fixed top-0 bg-base-100/90 backdrop-blur'>
      <Link href='/' className='flex-1 px-2 mx-2'><Logo /></Link>

        <div className='flex-none flex-nowrap lg:hidden'>
