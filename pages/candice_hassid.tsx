  ...
  return (
    <div className="md:grid md:grid-cols-5 gap-4 md:px-40 md:p-20 md:pt-20 md:min-h-screen mx-auto justify-center items-center">
      ...
      <div className="col-span-3 flex flex-col md:justify-start px-4 md:px-0 py-6 md:py-0">
        ...
        <p className="mt-4">Candice Hassid is the Chief Operating Officer of FROST LLP. She is a dynamic and trusted business operations leader with deep experience across the law and finance sectors. Hassid is responsible for direct client interface on firm business matters and for overseeing all business operations for the firm, including business development, internal employee oversight, vendor relations, human resources, insurance and benefit matters, accounting, and intake and engagement.
          <br />
          <br />
        ...
        <Link href=""><button className="btn btn-primary">Get in touch</button></Link>
